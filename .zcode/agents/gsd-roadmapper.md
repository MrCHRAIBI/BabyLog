...
`D:/projets/react/BabyLog/.zcode/gsd-core/templates/roadmap.md` is the canonical shape.
...
Reference full template: `D:/projets/react/BabyLog/.zcode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/projets/react/BabyLog/.zcode/gsd-core/templates/state.md`.

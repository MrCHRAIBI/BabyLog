...
```
Agent(
  prompt="Read D:/projets/react/BabyLog/.zcode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projets/react/BabyLog/.zcode/gsd-core/templates/SECURITY.md`

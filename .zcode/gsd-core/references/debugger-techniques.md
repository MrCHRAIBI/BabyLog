...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/projets/react/BabyLog/.zcode
                  → checks D:/projets/react/BabyLog/.zcode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/projets/react/BabyLog/.zcode/gsd-core
                  → writes to D:/projets/react/BabyLog/.zcode/gsd-core/hooks/

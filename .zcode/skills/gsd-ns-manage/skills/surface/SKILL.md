...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/projets/react/BabyLog/.zcode/.gsd-surface.json`
(sibling to `D:/projets/react/BabyLog/.zcode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/projets/react/BabyLog/.zcode/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/projets/react/BabyLog/.zcode/skills`).
...
`D:/projets/react/BabyLog/.zcode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/projets/react/BabyLog/.zcode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/projets/react/BabyLog/.zcode/.gsd-surface.json`
Install profile marker: `D:/projets/react/BabyLog/.zcode/.gsd-profile`
Skill dirs: `D:/projets/react/BabyLog/.zcode/skills/gsd-*/`
Engine module: `D:/projets/react/BabyLog/.zcode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/projets/react/BabyLog/.zcode/gsd-core/bin/lib/clusters.cjs`
</execution_context>

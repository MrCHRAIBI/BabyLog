...
Use template from `D:/projets/react/BabyLog/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `D:/projets/react/BabyLog/.claude/gsd-core/templates/UI-SPEC.md`

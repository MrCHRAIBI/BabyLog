...
<!-- For checkpoint task examples and patterns, see @D:/projets/react/BabyLog/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/projets/react/BabyLog/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/projets/react/BabyLog/.claude/gsd-core/templates/user-setup.md` for full schema and examples

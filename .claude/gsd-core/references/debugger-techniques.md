...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/projets/react/BabyLog/.claude
                  → checks D:/projets/react/BabyLog/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/projets/react/BabyLog/.claude/gsd-core
                  → writes to D:/projets/react/BabyLog/.claude/gsd-core/hooks/

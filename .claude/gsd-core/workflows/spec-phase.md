...
ones). Reference: @D:/projets/react/BabyLog/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/projets/react/BabyLog/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/projets/react/BabyLog/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/projets/react/BabyLog/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/projets/react/BabyLog/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/projets/react/BabyLog/.claude/gsd-core/templates/spec.md.

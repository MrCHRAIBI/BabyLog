...
<template>
@D:/projets/react/BabyLog/.claude/gsd-core/templates/UAT.md
</template>
...
Read and follow `D:/projets/react/BabyLog/.claude/gsd-core/workflows/transition.md`.
...
- Follow @D:/projets/react/BabyLog/.claude/gsd-core/workflows/diagnose-issues.md

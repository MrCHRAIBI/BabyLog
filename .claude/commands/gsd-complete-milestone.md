...
- @D:/projets/react/BabyLog/.claude/gsd-core/workflows/complete-milestone.md (main workflow)
- @D:/projets/react/BabyLog/.claude/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>

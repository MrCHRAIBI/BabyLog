...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/projets/react/BabyLog/.claude/.gsd-surface.json`
(sibling to `D:/projets/react/BabyLog/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/projets/react/BabyLog/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/projets/react/BabyLog/.claude/skills`).
...
`D:/projets/react/BabyLog/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/projets/react/BabyLog/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/projets/react/BabyLog/.claude/.gsd-surface.json`
Install profile marker: `D:/projets/react/BabyLog/.claude/.gsd-profile`
Skill dirs: `D:/projets/react/BabyLog/.claude/skills/gsd-*/`
Engine module: `D:/projets/react/BabyLog/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/projets/react/BabyLog/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
